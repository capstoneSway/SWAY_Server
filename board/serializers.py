...
class CommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ('id', 'username', 'nickname', 'profile_image', 'board_id', 'date', 'parent_id', 'parent_username', 'parent_nickname', 'content', 'like_count', 'reply')
        read_only_fields = [
...
class CommentDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ('id', 'username', 'profile_image', 'board_id' ,'date', 'parent_id', 'parent_nickname', 'content')
        read_only_fields = [
            'id', 'user', 'username', 'nickname', 'profile_image', 'board_id',
