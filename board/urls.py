...
urlpatterns = [
    ...
    path('<int:pk>/block-user/', AddBlockUserView.as_view(),name='block-board-user'),
    ...
    path('<int:board_id>/comments/<int:pk>/block-user/', AddBlockCommentUserView.as_view(), name='block-comment-user'),
