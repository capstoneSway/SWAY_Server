...
urlpatterns = [
    ...
    path('<int:pk>/block/', AddBlockUserView.as_view(),name='block-board-user'),
    ...
    path('<int:board_id>/comments/<int:pk>/block/', AddBlockCommentUserView.as_view(), name='block-comment-user'),
